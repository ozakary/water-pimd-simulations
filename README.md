...
1. Open the GUI and leave all simulation parameters at their default values, except for `Number of Beads` and `Total Step`, which should be set to `16` and `10000`, respectively. Then, run the PIMD simulation.
