...
VENV_PATH="$SCRIPT_DIR/pimd_sim_venv"
...
def main():
    ...
    print("1. Activate the virtual environment: source pimd_sim_venv/bin/activate")
    print("2. Run: python water_pimd_gui.py")
    print("\nAlternatively, use the provided run script: ./run_pimd_simulation.sh")
